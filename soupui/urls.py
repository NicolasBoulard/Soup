...
urlpatterns = [
    ...
    path("service/threshold", views.threshold, name="threshold"),
    path("service/threshold/add", views.threshold_add, name="threshold_add"),
    path("service/threshold/edit/<int:threshold_id>/", views.threshold_edit, name="threshold_edit"),
    path("service/threshold/remove", views.threshold_remove, name="threshold_remove"),
